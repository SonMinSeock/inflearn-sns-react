...
function App() {
  return (
    <div>
      ...
      {/*3. 사이즈*/}
      <div className="w-20 bg-blue-500">Box1</div>
      <div className="w-[20px] bg-emerald-300">Box2</div>
      <div className="w-full bg-purple-500">Box3</div>
      <div className="h-20 bg-olive-500">Box4</div>
      ...
      {/*5. border */}
      <div className="m-5 rounded-md border-x-2 border-y-2 border-red-500">
        border
      </div>
